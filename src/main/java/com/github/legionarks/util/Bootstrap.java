...
public class Bootstrap {
    ...
    private void properties() {
        ...
        property.setAttributes(Set.of(
                new PropertyAttribute(propertyService.getAttributeDao().find(AttributeType.ROOM), (short) 5),
                new PropertyAttribute(propertyService.getAttributeDao().find(AttributeType.BATH), (short) 7),
                new PropertyAttribute(propertyService.getAttributeDao().find(AttributeType.PARKING), (short) 2),
                new PropertyAttribute(propertyService.getAttributeDao().find(AttributeType.AREA), (short) 208)));
        property.setFeatures(Set.of(propertyService.getFeatureDao().find(FeatureType.POOL),
                propertyService.getFeatureDao().find(FeatureType.ALARM)));
        property.setMedias(Set.of(new Media("inside-01"), new Media("inside-02")));
