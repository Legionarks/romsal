...
public class HomeResource {
        ...
        public TemplateInstance main() {
                ...
                transcript.put("service-1", List.of(transcript.get("home.service.title.1"),
                                transcript.get("home.service.phrase.1")));
                transcript.put("service-2", List.of(transcript.get("home.service.title.2"),
                                transcript.get("home.service.phrase.2")));
                transcript.put("service-3", List.of(transcript.get("home.service.title.3"),
                                transcript.get("home.service.phrase.3")));
